...
function init() {
  console.log('[Office Generator V5] 初始化場景...');
  ...
  console.log('[Office Generator V5] 場景初始化完成！');
}
...
function createOffice() {
  console.log('[Office Generator V5] 創建辦公室...');
  ...
  console.log('[Office Generator V5] 辦公室創建完成！');
}
...
function createWorkstation(x, z, index) {
  ...
  createPersonalItems(group, index);  // 個人物品
...
function setupLighting() {
  ...
  indoorLights.forEach((pos, i) => {
    const pointLight = new THREE.PointLight(0xFFF5E6, 0.6, 10, 2);
  ...
  console.log('[Office Generator V5] 燈光設置完成（含陰影）');
}
...
function setupPostProcessing() {
  ...
  console.log('[Office Generator V5] 後處理設置完成');
}
...
console.log('[Office Generator V5] 辦公室場景生成完成！');
console.log('[Office Generator V5] 改進項目：');
console.log('  ✅ 開啟陰影');
console.log('  ✅ 更多細節（檔案夾、筆、書籍）');
console.log('  ✅ 個人物品（增加生活感）');
console.log('  ✅ 裝飾品（掛畫、時鐘、植物）');
console.log('  ✅ 改進材質（布料、木紋、金屬）');
console.log('  ✅ 更好的光照');
