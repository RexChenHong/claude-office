...
print(f"  原始動畫: {len(bpy.data.actions)} 個")
...
keyframes = [
    (0, 0, 0, 0, 0),           # 站立
    (15, -0.2, 0.15, 0.6, 0.08),  # 彎腰
    (30, -0.5, 0.4, 1.0, 0.15),   # 下蹲
    (45, -0.7, 0.6, 1.2, 0.2),    # 繼續
    (60, -0.8, 0.7, 1.3, 0.25),   # 坐下
]
...
# 反向關鍵幀
keyframes = [
    (0, -0.8, 0.7, 1.3, 0.25),  # 坐著
    (15, -0.7, 0.6, 1.2, 0.2),  # 準備起身
    (30, -0.5, 0.4, 1.0, 0.15), # 起身
    (45, -0.2, 0.15, 0.6, 0.08),# 接近站立
    (60, 0, 0, 0, 0),           # 站立
]
